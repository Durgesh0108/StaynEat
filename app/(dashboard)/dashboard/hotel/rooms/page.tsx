    ...
    return (
      <div className="space-y-5">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your hotel rooms and availability</p>
        </div>
        <RoomsManagement
          businessId={business.id}
          initialRooms={rooms as Parameters<typeof RoomsManagement>[0]["initialRooms"]}
        />
      </div>
    );
  } catch (err) {
